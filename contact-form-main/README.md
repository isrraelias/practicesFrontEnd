...
- Completar el formulario y ver un mensaje de confirmación tras el envío exitoso
...
- Recibir mensajes de error, entradas y el mensaje de confirmación en el lector de pantalla
...
Tu tarea es desarrollar el proyecto con los diseños dentro de la carpeta `/design`. Encontrarás una versión móvil y una versión de escritorio del diseño.
